  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-semibold text-primary">Planificación de eventos</h1>
          <p className="text-sm text-neutral-500">Monitorea las próximas experiencias y coordina equipos sin esfuerzo.</p>
        </div>
        ...
        {filteredEvents.map((event) => (
          <Card key={event.id} className="flex flex-col gap-3">
            ...
            <div className="flex items-center gap-4 text-sm text-neutral-500">
              ...
              <span>{event.attendees} invitados</span>
            </div>
            <p className="text-sm text-neutral-500">{event.notes ?? 'Sin notas adicionales.'}</p>
            <div className="flex items-center justify-between">
      ...
      <Modal
        ...
        description="Planifica cada detalle incluyendo menús, personal y requerimientos de inventario."
        primaryAction={{ label: 'Guardar evento', onClick: handleCreateEvent }}
      ...
      >
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <InputField
            ...
            placeholder="Boda, conferencia, gala..."
        ...
        <TextAreaField
          label="Notas"
          placeholder="Comparte contexto, notas logísticas o consideraciones VIP"
