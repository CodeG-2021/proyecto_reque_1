    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-primary/10 via-white to-neutral-100 px-4 py-10">
      <Card className="w-full max-w-lg p-10">
        <div className="mb-8 space-y-2 text-center">
          <h1 className="text-2xl font-semibold text-primary">Plataforma de Gestión de Catering</h1>
          <p className="text-sm text-neutral-500">Inicia sesión para orquestar eventos inolvidables.</p>
        </div>
